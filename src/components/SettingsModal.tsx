...
import { ROLES, UserSettings, DEFAULT_SETTINGS, MODELS, getActiveAgent } from '../agents';
    ...
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-zinc-950 border border-zinc-800 w-full max-w-2xl max-h-[90vh] flex flex-col rounded-lg shadow-2xl overflow-hidden">
        <div className="flex justify-between items-center p-6 border-b border-zinc-800 shrink-0 bg-zinc-950">
          <h2 className="text-xl font-mono font-bold tracking-widest uppercase text-white">Council Configuration</h2>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full bg-black border border-zinc-800 text-white p-3 font-sans text-sm focus:outline-none focus:border-zinc-500"
                    >
                      {role.thinkers.map(t => (
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full bg-black border border-zinc-800 text-white p-3 font-mono text-xs focus:outline-none focus:border-zinc-500 h-32 resize-none"
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="p-6 border-t border-zinc-800 flex justify-between shrink-0 bg-zinc-950">
          ...
          <button 
            onClick={onClose}
            className="px-6 py-2 bg-white text-black font-mono font-bold uppercase tracking-widest hover:bg-zinc-200 transition-colors"
          >
            Done
          </button>
        </div>
